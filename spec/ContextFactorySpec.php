...
class ContextFactorySpec extends ObjectBehavior
{
    ...
    public function it_should_passthru_a_previously_instantiated_context()
    {
    ...
    public function it_should_assign_properties_and_source_attributes_on_the_context()
    {
    ...
    public function it_should_throw_marshal_exception_when_parameter_cannot_be_resolved()
    {
