...
class ContextFactory {
  ...
  public static function create($context, array $attributes = [ ]) {
    ...
    $attributes['attributes'] = array_merge($attributes['attributes'], $extraAttributes);
   ...
   */
  protected static function getParameterValueForContext($context, ReflectionParameter $parameter, array $attributes = [ ]) {
    ...
    throw new MarshalException(
      sprintf('Could not resolve [%s] parameter on [%s]',
        $parameter->name,
        $context
      )
    );
